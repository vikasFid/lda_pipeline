...
load(file = "adhocOutput/LDAVis_JSON.RData")
load(file = "adhocOutput/myAPdata.RData")
load(file = "adhocOutput/ldaModel.RData")
...
write.csv(output,file = 'adhocOutput/topic_terms.csv',
          row.names = F, quote =  F)
