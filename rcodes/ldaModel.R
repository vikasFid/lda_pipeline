...
save(json, file = "LDAVis_JSON.RData")
save(myAPdata, file = "myAPdata.RData")

#load(file = "C:/Users/a592407/Desktop/LDA_RDATA/LDAVis_REDEEM_ALL.RData")
serVis(json,out.dir="SCRIPT_LDA_VIS", open.browser = F)
...
write.csv(topicProbabilities,file="TOPIC_PROB.csv",
           row.names = F)
...
write.csv(doc_df,file = "DOC_TOPIC.csv",row.names = F)
