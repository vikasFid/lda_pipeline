...
def getTopicContext():
    ...
    for index,row in df.iterrows():	
		...
		if topic_presence == 1:
			...
			#because context terms will occur together and thus phrased strings will exist with unigrams in context
    ...
    df_clean_trans.to_csv('adhocOutput/adhoc_doc_topics.csv')
